...
export const config: Config = {
  economy: [
    ...
    },
    {
      ...
      description:
        "Expenditure on Research and Development at national and regional level (percentage of GDP)",
  ...
  environment: [
...

    {
      ...
      description: "Waste generated by households by year in tonnes",
      dataSetCode: "ten00110",
      params: {
        unit: "T",
        hazard: "HAZ_NHAZ",
        nace_r2: "EP_HH",
